...
SELECT
 ...
 ,CASE 
     ...
     ELSE NULL
  END class_conflicts
  -- working with the `learning_objective_business` attribute
 ,learning_objective_business
 ,cast(learning_objective_business AS BINARY) AS learning_objective_business_casted
